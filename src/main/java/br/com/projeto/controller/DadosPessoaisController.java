...
public class DadosPessoaisController {
	...
	@DeleteMapping("/apagardadospessoais/{id}")
	public String apagardadospessoais(@PathVariable Integer id) {
		Optional<Dadospessoais> dados = dpr.findById(id);
		if(!dados.isPresent()) {
